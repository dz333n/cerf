...
This entire codebase — every line of C++, every thunk, every CPU instruction handler — was generated by [Claude](https://claude.ai) using [Claude Code](https://docs.anthropic.com/en/docs/claude-code). No human-written code. Contributions from both humans and Claude are welcome.
